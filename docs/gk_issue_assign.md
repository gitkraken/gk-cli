...
### Synopsis
  ...
  This command allows you to assign an issue to a user. Available providers: github, github_enterprise, gitlab, gitlab_self_hosted, jira, jira_server, azure, linear, trello
