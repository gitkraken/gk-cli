...
Perform a 'git push' command within every repos selected

### Synopsis

Perform a 'git push' command within all repos of a workspace. You can pass args and flags to the git command
