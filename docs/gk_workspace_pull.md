...
Perform a 'git pull' command within all repos of a workspace

### Synopsis

Perform a 'git pull' command within all repos of a workspace. Pass flags to the git command by providing '--'.
